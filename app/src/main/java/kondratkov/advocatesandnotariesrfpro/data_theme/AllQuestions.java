...
public class AllQuestions {
    ...
    public AllQuestions(int id, int idt, int idu, int idj, String date, String name, int count, int place, int read, String text, int theme) {
    ...
    // Конструктор с параметрами
    public AllQuestions(int idt, int idu, int idj, String date, String name, int count, int place, int read, String text, int theme){
