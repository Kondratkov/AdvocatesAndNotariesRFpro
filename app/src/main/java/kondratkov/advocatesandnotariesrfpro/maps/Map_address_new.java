...
import static kondratkov.advocatesandnotariesrfpro.IN.context;

public class Map_address_new extends Activity implements GoogleMap.OnMapClickListener {
    ...
    public i_dialog_map_address interface_map_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = gson_Search.fromJson((String)getIntent().getSerializableExtra("ADDRESS"),Address.class);

        interface_map_address= (i_dialog_map_address) in.get_context();
    ...
    private class MyLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            Toast.makeText(Map_address_new.this, message, Toast.LENGTH_LONG)
                    .show();
            showCurrentLocation(mLocation);
        }

        public void onStatusChanged(String s, int i, Bundle b) {
            Toast.makeText(Map_address_new.this, "Статус провайдера изменился",
                    Toast.LENGTH_LONG).show();
        }

        public void onProviderDisabled(String s) {
            Toast.makeText(Map_address_new.this,
        ...
        switch (v.getId()){
            case R.id.map_new_but_add:
                if(map_new_tv_address.getText().equals("")){
                    ...
                    interface_map_address.dialogMapAddress(address);//.iv_dialog_address(address);

                    Map_address_new.this.finish();
                }
                break;
    ...
    public static interface i_dialog_map_address{
